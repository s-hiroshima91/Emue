...
/*対象の値を左シフト*/
int Cpu::Asl(uint16_t addr){
	return RMW(addr, &Cpu::AslA);
}
...
/*対象の値を右シフト*/
int Cpu::Lsr(uint16_t addr){
	return RMW(addr, &Cpu::LsrA);
}
...
/*対象の値をキャリー含めて左シフト*/
int Cpu::Rol(uint16_t addr){
	return RMW(addr, &Cpu::RolA);
}
...
/*対象の値をキャリー含めて右シフト*/
int Cpu::Ror(uint16_t addr){
	return RMW(addr, &Cpu::RorA);
}
...
/*対象の値をインクリメント*/
int Cpu::Inc(uint16_t addr){
	return RMW(addr, &Cpu::InO);
}
...
/*対象の値をデクリメント*/
int Cpu::Dec(uint16_t addr){
	return RMW(addr, &Cpu::DeO);
}
